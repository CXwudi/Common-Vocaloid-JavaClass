...
public class VocaDbPvTest {
  ...
  /**
   * {@link VocaDbPv#equals(Object)} should handles these situation
   */
  @Test
  void testEquals() {
  ...
  /**
   * {@link VocaDbPv#compareTo(VocaDbPv)} should return 0 when {@link VocaDbPv#equals(Object)} return true,
   * also
   */
  @Test
  void compareTo() {
